...
export default {
    ...
    methods:{
        ...
        updateDescriptionTodo( id, description ){
             this.todos = this.todos.map(todo => {
                if(todo.id === id){
        ...
        setCurrentFilter( newFilter = Filters.All ){
    ...
    <div id="todo-app">    
        ...
        <section class="todoapp">
            ...
            <section class="main">
                ...
                <ul class="todo-list">
                    <TodoList :todos="todos" @eliminar="id => eliminar(id)" />
                </ul>
            </section>
